    ...
    public class ClothingBindHelper : MonoBehaviour, IPreview
    {
        ...
        private void TestClothingMeshInPlayMode()
        {
            ...
            foreach (var r in renderers)
            {
                ...
                var smr = newObject.GetComponent<SkinnedMeshRenderer>();

                r.updateWhenOffscreen = true;
                smr.rootBone = boneRoot.transform;
                var boneNames = smr.bones.ToDictionary(x => x.name);
                ...
                smr.bones = boneNames.Values.ToArray();
